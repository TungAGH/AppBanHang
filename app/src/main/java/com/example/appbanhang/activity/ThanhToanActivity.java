...
public class ThanhToanActivity extends AppCompatActivity {
    ...
    private String merchantName = "HaoTung";
    private String merchantCode = "thiếu mã";
    private String merchantNameLabel = "HaoTung";
    private String description = "Buy online";
    ...
    private void initControl() {
        ...
        btndathang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(str_diachi)){
                    Toast.makeText(getApplicationContext(), "You have not entered an address", Toast.LENGTH_SHORT).show();
                }else {
                    //post data
                    String str_email = Utils.user_current.getEmail();
                    String str_sdt = Utils.user_current.getMobile();
                    int userid = Utils.user_current.getId();
                    Log.d("test", new Gson().toJson(Utils.mangmuahang)); //chi de kiem tra
                    
                    compositeDisposable.add(apiBanHang.createOder(str_email,str_sdt,String.valueOf(tongtien),userid,str_diachi,totalItem, new Gson().toJson(Utils.mangmuahang))
                            .subscribeOn(Schedulers.io())
                            .observeOn(AndroidSchedulers.mainThread())
                            .subscribe(
                                messageModel -> {
        ...
        btnmomo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String str_diachi = edtdiachi.getText().toString().trim();
                if (TextUtils.isEmpty(str_diachi)){
                    Toast.makeText(getApplicationContext(), "You have not entered an address", Toast.LENGTH_LONG).show();
                }else {
                    //post data
                    String str_email = Utils.user_current.getEmail();
                    String str_sdt = Utils.user_current.getMobile();
