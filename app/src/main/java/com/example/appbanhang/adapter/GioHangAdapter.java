...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.item_giohang_tensanpham.setText(gioHang.getTensanpham());
        holder.item_giohang_soluong.setText(gioHang.getSoluong() +" ");
        Glide.with(context).load(gioHang.getHinhsanpham()).into(holder.item_giohang_image);
        DecimalFormat decimalFormat = new DecimalFormat("###,###,###");
        holder.item_giohang_gia.setText(decimalFormat.format((gioHang.getGiasanpham())) );
        long gia = gioHang.getSoluong() * gioHang.getGiasanpham();
        holder.item_giohang_giasanpham2.setText(decimalFormat.format(gia));
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b){
                    ...
                    for (int i = 0; i<Utils.mangmuahang.size(); i++){
                        if (Utils.mangmuahang.get(i).getIdsanpham() == gioHang.getIdsanpham()){
            ...
            public void onImageClick(View view, int pos, int giatri) {
                if (giatri == 1){
                    if (gioHangList.get(pos).getSoluong() > 1){
                        ...
                        builder.setTitle("Notifycation");
                        builder.setMessage("Would you like to remove this product from your cart?");
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TextView item_giohang_tensanpham, item_giohang_gia, item_giohang_soluong, item_giohang_giasanpham2;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            item_giohang_giasanpham2 = itemView.findViewById(R.id.item_giohang_giasanpham2);
